...
class Config:
    ...
    def get_default_config(args):
        ...
        config.SUBTOKENS_VOCAB_MAX_SIZE = 100000  # 190000 #
        config.TARGET_VOCAB_MAX_SIZE = 15000  # 27000 #
    ...
    def __init__(self, args):
        if args:
            ...
            self.SAVE_PATH = self.SAVE_PATH if not self.SAVE_PATH or self.SAVE_PATH[-1] == '/' else self.SAVE_PATH + '/'
            self.LOAD_PATH = self.LOAD_PATH if not self.LOAD_PATH or self.LOAD_PATH[-1] == '/' else self.LOAD_PATH + '/'
        else:
