...
DATASET_NAME=python-huge-inlining-descriptors
MAX_DATA_CONTEXTS=1000
MAX_CONTEXTS=200
SUBTOKEN_VOCAB_SIZE=100000 #186277
TARGET_VOCAB_SIZE=15000 #26347
NUM_THREADS=12
PYTHON=python3
###########################################################

TRAIN_DATA_FILE=C:/Workspace/ReadmeGeneration/DatasetCreation/data/python-projects-huge/inlining-descriptors/processed/train/postprocessed/data.csv
VAL_DATA_FILE=C:/Workspace/ReadmeGeneration/DatasetCreation/data/python-projects-huge/inlining-descriptors/processed/testset/postprocessed/data.csv
TEST_DATA_FILE=C:/Workspace/ReadmeGeneration/DatasetCreation/data/python-projects-huge/inlining-descriptors/processed/testset/postprocessed/data.csv
